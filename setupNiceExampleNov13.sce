...
//   Example from Chapter 9 (Nice example 9.5 p483)
...
tsd =    0.55;   // Desired Settling Time
pod =    1.20;   // Desired Percent Overshoot
ssed =    0.0;   // Desired Steady State Error
gmd =    10000;   // Desired Gain Margin in dB
...
nvals = 6 ; // number of gain values to try btwn kmax and kmin
...
scale_range = 3;    // how big a range to search.
